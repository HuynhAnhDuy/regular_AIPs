...
# ====== Run Models ======
def run_model(X_train, y_train, X_test, y_test, n_repeats=3):
    ...
    for repeat in range(n_repeats):
        ...
        # Tính trung bình probability từ 3 base models
        avg_probs = np.mean(model_preds, axis=0)

        # Tính metrics
        metrics = evaluate_model(y_test, avg_probs)
...
def main():
    ...
    run_model(X_train, y_train, X_test, y_test, n_repeats=3)
